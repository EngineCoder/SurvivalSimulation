// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WebRpcHandler.cs" company="Exit Games GmbH">
...
namespace Photon.Hive.WebRpc
{
    ...
    public class WebRpcHandler:  IHttpRequestQueueCounters
    {
        ...
        public void HttpRequestExecuteTimeIncrement(long ticks)
        {
            ...
            this.rpcAppCounters.IncrementWebHooksHttpRequestExecTime((uint) (ticks/Stopwatch.Frequency) * 1000);
        }
        ...
        private class NullAppCounters : IRpcHandlerAppCounters
        {
            ...
            public void IncrementWebHooksHttpRequestExecTime(uint milliseconds)
            {
            }
        }
