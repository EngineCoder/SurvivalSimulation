namespace Photon.Hive.Operations
{
    public class HiveErrorMessages
    {
        ...
        public const string CacheSliceNoAvailable = "Requested cache slice={0} not available.";
        ...
        public const string UsageOfSetPropertiesNotAllowedBeforeContinue = "Usage of SetProperties is prohibited before calling ICreateGameCallInfo.Continue, Game:{0}, CallStack:{1}";
