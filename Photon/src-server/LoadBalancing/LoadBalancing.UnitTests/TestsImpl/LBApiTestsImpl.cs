...
//                Assert.IsNotNull(response.Parameters[ParameterCode.Token]);
        ...
        public virtual void Auth_JoinGameTest(AuthPolicy policy, EncryptionMode encryptionMode)
        {
            ...
            if (this.connectPolicy.Protocol == ConnectionProtocol.Tcp &&
                (encryptionMode == EncryptionMode.DatagramEncryption ||
                 encryptionMode == EncryptionMode.DatagramEncryptionGCM ||
                 encryptionMode == EncryptionMode.DatagramEncryptionRandomSequence))
            {
                Assert.Ignore("Tcp protocol does not support Datagramm encryption");
            }
...
//                masterClient.Disconnect();
        ...
        public void LobbyGameListEvents()
        {
            ...
            try
            {
                ...
                masterClient2.CheckThereIsEvent(EventCode.AppStats, MasterServer.MasterServerSettings.Default.AppStatsPublishInterval*3);
...
//        [TestCase("SetPropertiesFromOnCreateGame", ErrorCode.PluginReportedError)]
        ...
        public void FastReJoinTest(string useCase)
        {
            ...
            try
            {
                ...
                masterClient12.EncryptionData = masterClient1.EncryptionData;
        ...
        public void CacheClearTest()
        {
            ...
            try
            {
                ...
                var cnt = 0;
                while (client2.Connected && cnt < 6) //wait until we get disconnected
                {
                    Thread.Sleep(1000);
                    cnt++;
                }

                Assert.IsFalse(client2.Connected, "Expected client2 to be disconnected.");
        ...
        public void RejoinWhileInGameZeroPlayerTTL()
        {
            ...
            try
            {
                ...
                client3.EncryptionData = client2.EncryptionData;
        ...
        public void PlayerTtlTimeExpiredWhileGameInStorageTest()
        {
            ...
            try
            {
                ...
                var masterClient2EncData = masterClient2.EncryptionData;
                Thread.Sleep(3000);
                ...
                masterClient2.EncryptionData = masterClient2EncData;
        ...
        public void SendUnknownOperationToGame()
        {
            if (this.IsOnline)
            {
                Assert.Ignore("this test supported only in offline mode");
            }
            ...
            try
            {
                ...
                if (!GameServer.GameServerSettings.Default.Limits.Inbound.Operations.BlockNonRegisteredOps)
                {
                    client1.SendRequestAndWaitForResponse(new OperationRequest
                    {
                        OperationCode = 216
                ...
                else
                {
                    ...
                    Thread.Sleep(6000); //wait for disconnect, when sending unknown op, server should disconnect the client without any response
