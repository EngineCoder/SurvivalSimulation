...
namespace Photon.LoadBalancing.UnitTests
{
    public abstract class PluginTestsImpl : LoadBalancingUnifiedTestsBase
    {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.GameProperties, new Hashtable
                        {
                            ...
                            {GamePropertyKey.PropsListedInLobby, new[]{"LobbyProperty", "LobbyPropertyValue"}}
                        }
                        },
                        {ParameterCode.PlayerProperties, new Hashtable {{"Actor1Property1", "Actor1Property1Value"}}},
                        {ParameterCode.Plugins, new[]{"BasicTestsPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"SetStateAfterContinueTestPlugin"}},
        ...
        public void OnCreateWithErrorPluginTest()
        {
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.Plugins, new[]{"ErrorPlugin"}},
                    }
                };
                ...
                Assert.IsFalse(client.TryWaitForEvent(EventCode.Join, 3000, out _));
            }
            finally
            {
                if (client != null && client.Connected)
        ...
        public void OnCreateUsingStripedGameStateTest()
        {
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.Plugins, new[]{"StripedGameStatePlugin"}},
                    }
                };
                ...
                Assert.IsTrue(client.TryWaitForEvent(EventCode.Join, 3000, out _));
            }
            finally
            {
                if (client != null && client.Connected)
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.Plugins, new[]{"JoinFailuresCheckPlugin"}},
                    }
                };
        ...
        [Test]
        public void SlotsFromPluginOnCreate()
        {
            UnifiedTestClient client1 = null;
            UnifiedTestClient client2 = null;
            UnifiedTestClient client3 = null;
            var GameName = MethodBase.GetCurrentMethod().Name;
            this.WaitTimeout = 30000000;
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.Plugins, new string[] {"SettingSlotsPlugin"}},
                    }
                };

                var response = client1.SendRequestAndWaitForResponse(request);
                client1.Token = response[ParameterCode.Token];
                ...
                this.JoinGame(client3, request, (short)ErrorCode.GameFull);
                this.JoinGame(client2, request, (short)ErrorCode.Ok);
            }
            finally
            {
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"JoinExceptionsPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.Plugins, new[] {"OnLeaveExceptionsPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"ActorPropertiesBroadcastDuringJoin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.Plugins, new[]{"ScheduleBroadcastTestPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.Plugins, new[]{"ScheduleSetPropertiesTestPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.Plugins, new[]{"MasterClientIdPlugin"}},
                    }
                };
        ...
        private static void CheckActorPropertyValue(UnifiedTestClient client, string propertyName, string expectedPropertyValue)
        {
            ...
            var request = new OperationRequest
            {
                ...
                Parameters = new Dictionary<byte, object>
                {
                    ...
                    {ParameterCode.PlayerProperties, new[] {propertyName}},
        ...
        public void UpdateGamePropertiesOnMasterFromPlugin()
        {
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.Plugins, new[] {"ChangeGamePropertiesOnJoinPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"RaiseEventChecksPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"CustomTypeCheckPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{httpVersion == "NewHttp" ? "SyncAsyncHttpTestPlugin" : "SyncAsyncHttpTestPluginOldHttp"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"SyncAsyncHttpTestPlugin"}},// this test for new http only
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"HttpRequestNullCallInfoPlugin" }},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"CustomTypeMapperPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{httpVersion == "NewHttp" ? "StrictModeFailurePlugin" : "StrictModeFailurePluginOldHttp"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, gameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"StrictModeFailurePlugin"}},// no http used in this test
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, gameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[] {"StrictModeFailurePlugin"}},// here we do not use http
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, gameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[] {"StrictModeFailurePlugin"}},// in this test we do not use http
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"WrongUrlTestPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{pluginName}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[] {"CacheOpPlugin"}},
                    }
                };
                ...
                client3.Token = response[ParameterCode.Token];
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.Plugins, new[] {"RemovingActorPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.Plugins, new[] {"BroadcastEventPlugin"}},
                    }
                };
                ...
                this.JoinGame(client2, request, (short)ErrorCode.Ok);
                this.JoinGame(client3, request, (short)ErrorCode.Ok);
        ...
        [Test]
        public void SameInstanceOfPluginTest()
        {
            UnifiedTestClient client1 = null;
            UnifiedTestClient client2 = null;
            var GameName = MethodBase.GetCurrentMethod().Name;
            ...
            if (this.IsOffline)
            {
                var offlineCp = ((OfflineConnectPolicy)this.connectPolicy);

                offlineCp.GameServer2.Stop();
            }
            try
            {
                client1 = this.CreateMasterClientAndAuthenticate("Player1");
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.PlayerTTL, 10000},
                        {ParameterCode.Plugins, new[] {"SameInstancePlugin"}},
                    }
                };

                var response = client1.SendRequestAndWaitForResponse(request);
                client1.Token = response[ParameterCode.Token];
                this.ConnectAndAuthenticate(client1, (string)response[ParameterCode.Address]);
                client1.SendRequestAndWaitForResponse(request);
                client1.CheckThereIsEvent(EventCode.Join);
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.Plugins, new[]{"OneTimeTimerTestPlugin"}},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.EmptyRoomTTL, 0},
                        {ParameterCode.Plugins, new[]{"OneTimeTimerNullCallInfoPlugin" }},
                    }
                };
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.Plugins, new[]{"OnRaiseEventTimerTestPlugin"}},
                    }
                };
        ...
        protected virtual void ApiConsistenceTestBody(string gameNameSuffix)
        {
            ...
            try
            {
                ...
                var request = new OperationRequest
                {
                    ...
                    {
                        {ParameterCode.RoomName, GameName},
                        {ParameterCode.Plugins, new[] {"ApiConsistenceTestPlugin"}},
                    }
                };
                ...
                var request = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        ...
                        {ParameterCode.JoinMode, (byte)JoinMode.CreateIfNotExists},
                        {
                            ...
                            {
                                {"config", ""},
                                {GamePropertyKey.PropsListedInLobby, new[]{"config"}}
                            }
                        },
                        {ParameterCode.Plugins, new[]{plugin}},
                    }
                };
        ...
        private void JoinGame(UnifiedTestClient client, OperationRequest request, short expectedJoinGameResult)
        {
            var response = client.SendRequestAndWaitForResponse(request, expectedJoinGameResult);
            ...
            client.Token = response[ParameterCode.Token];
            this.ConnectAndAuthenticate(client, (string)response[ParameterCode.Address]);
            client.SendRequestAndWaitForResponse(request, expectedJoinGameResult);
            client.CheckThereIsEvent(EventCode.Join);
        }
