...
#if NETFRAMEWORK
            var cbpath = Path.GetDirectoryName(typeof(TestApplication).Assembly.CodeBase.Replace("file://", ""));
#else
            var cbpath = Path.GetDirectoryName(typeof(TestApplication).Assembly.Location);
