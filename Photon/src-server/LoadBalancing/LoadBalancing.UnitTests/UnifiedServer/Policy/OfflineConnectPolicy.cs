...
namespace Photon.LoadBalancing.UnitTests.UnifiedServer.Policy
{
    ...
    public class OfflineConnectPolicy : LBConnectPolicyBase
    {
        ...
        protected string pluginConfigFileName = "plugin.config";
        ...
        public OfflineConnectPolicy(IAuthenticationScheme scheme, string pluginConfigFileName = "")
        {
            this.AuthenticatonScheme = scheme;

            if (!String.IsNullOrEmpty(pluginConfigFileName))
            {
        ...
        public virtual PhotonApplicationProxy MasterServer => this.masterServer;

        public virtual PhotonApplicationProxy GameServer => this.gameServer;

        public virtual PhotonApplicationProxy GameServer2 => this.gameServer2;

        public virtual PhotonApplicationProxy NameServer => this.nameServer;

        public ITestMasterApplication MSApplication => (ITestMasterApplication)this.MasterServer.Application;

        public ITestGameServerApplication GSApplication => (ITestGameServerApplication)this.GameServer.Application;

        public ITestGameServerApplication GS2Application => (ITestGameServerApplication)this.GameServer2.Application;

        public override bool IsOffline => true;

        public override bool IsInited => (this.photonHost != null);
        ...
        protected virtual void InitApplications()
        {
            ...
            this.masterServer.Application.SetPluginConfig(this.pluginConfigFileName);
            ...
            this.gameServer.Application.SetPluginConfig(this.pluginConfigFileName);
            ...
            this.gameServer2.Application.SetPluginConfig(this.pluginConfigFileName);
