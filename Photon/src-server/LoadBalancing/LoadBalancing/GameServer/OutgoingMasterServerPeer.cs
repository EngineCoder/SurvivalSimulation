...
#pragma warning restore CS0649
        ...
        private void StartUpdateLoop()
        {
            ...
            if (log.IsDebugEnabled)
            {
                log.DebugFormat("starting server state update timer. connection:{0}", this.masterServerConnection.Name);
            }
        ...
        private void UpdateServerState()
        {
            ...
            this.UpdateServerState(this.application.WorkloadController, this.application.PeerCount);
        }

        private void UpdateServerState(WorkloadController workloadController, int peerCount)
        {
            var workload = workloadController.FeedbackLevel;
            var state = workloadController.ServerState;
