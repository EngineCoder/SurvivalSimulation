...
namespace Photon.LoadBalancing.MasterServer
{
    ...
    public sealed class MasterServerSettings
    {
        ...
        public class MSLimitSettings
        {
            ...
            {
                public int MaxStatsPublished { get; set; } = 10000; // this should be <= LobbySettings.Total
            ...
            public class InboundLimitSettings
            {
                public class OperationSettings
                {
                    ...
                    public int JoinLobbyRate { get; set; } = 1;

                    public int LeaveLobbyRate { get; set; } = 1;

                    public int CreateGameRate { get; set; } = 2;

                    public int JoinGameRate { get; set; } = 2;

                    public int JoinRandomGameRate { get; set; } = 2;

                    public int FindFriendsRate { get; set; } = 2;

                    public int LobbyStatsRate { get; set; } = 1;

                    public int SettingsRate { get; set; } = 1;

                    public int RpcRate { get; set; } = 1;

                    public int GetGameListRate { get; set; } = 1;
        ...
        public int ConnectionDisconnectTimeout { get; set; } = 2000;
