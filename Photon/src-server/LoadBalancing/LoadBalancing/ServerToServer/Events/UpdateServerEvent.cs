...
namespace Photon.LoadBalancing.ServerToServer.Events
{
    ...
    public class UpdateServerEvent : DataContract
    {
        ...
        [DataMember(Code=(byte)ServerParameterCode.PredictionAlgo, IsOptional = true)]
        public int? PredictionAlgo { get; set; }

        [DataMember(Code=(byte)ServerParameterCode.UseLoadPrediction, IsOptional = true)]
        public bool? UseLoadPrediction { get; set; }
        #endregion
    }
}