...
namespace Photon.Hive.Plugin
{
    ...
    public class RemoveActorReason
    {
        ...
        /// <summary>
        /// Actor was globally banned: user cannot join any room for a duration of double the token expiration duration (default is 2 * 1 hour = 2 hours).
        /// </summary>
    ...
    /// <summary>A serializable container of excluded (explicitly removed) actor info.</summary>
    [Serializable]
    ...
    public interface IPluginHost
    {
        ...
        /// <summary>
        /// Unique game identifier. Called RoomName in most client SDKs.
        /// </summary>
        string GameId { get; }
        ...
        /// - 0 if it should be the room itself (authoritative event).
        ...
        /// <param name="sendParameters">parameters which defines how event will be sent</param>
        ...
        /// <returns>a timer object which can be cancelled using <see cref="StopTimer" /></returns>
        [Obsolete]
        ...
        /// <param name="callback">Action called when timer is triggered</param>
        /// <param name="dueTimeMs">Time for callback to elapse</param>
        /// <param name="intervalMs">interval for callbacks to be called</param>
        /// <returns>a timer object which can be canceled using <see cref="StopTimer" /></returns>
        ...
        /// The http call is completely async, but it returns the result in a fiber compatible way.
        /// There are two modes for receiving a response:
        ///  - sync: this means effectively pausing the fiber until the response is received. 
        ...
        /// </summary>
        /// <param name="state">serialized state to affect to the room</param>
        ...
        /// <summary>
        /// Remove an actor from the room's actors list.
        /// If the reason is <see cref="RemoveActorReason.Banned"/> or <see cref="RemoveActorReason.GlobalBanned"/> the UserId will be added to the ExcludedActors list.
        /// </summary>
        ...
        /// <param name="deserializeFunction">Deserialization Method delegate to create customType instance from a byte[].</param>
        ...
        /// <summary>
        /// Enqueues action into rooms fiber. this guaranties thread safe access to rooms and plugins data
        /// </summary>
    ...
    public interface IGamePlugin
    {
        ...
        /// <summary>
        /// Callback triggered when trying to deserialize unknown type.
        /// </summary>
        /// <param name="type">The Type of the object.</param>
        /// <param name="value">The object with unknown type.</param>
        /// <returns>If the unknown type could be handled successfully.</returns>
