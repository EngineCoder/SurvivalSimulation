    ...
    public class Player
    {
        ...
        public bool SetCustomProperties(Hashtable propertiesToSet, Hashtable expectedValues = null, WebFlags webFlags = null)
        {
            ...
            if (this.RoomReference != null)
            {
                if (this.RoomReference.IsOffline)
                {
                    ...
                    this.CustomProperties.StripKeysWithNullValues();
                    // invoking callbacks
                    this.RoomReference.Client.InRoomCallbackTargets.OnPlayerPropertiesUpdate(this, customProps);
                    return true;
                }
                else
                {
                    ...
                    return this.RoomReference.Client.OpSetPropertiesOfActor(this.actorNumber, customProps, customPropsToCheck, webFlags);
                }
            }
            if (this.IsLocal)
            {
        ...
        private bool SetPlayerNameProperty()
        {
            if (this.RoomReference != null && !this.RoomReference.IsOffline)
            {
                ...
                return this.RoomReference.Client.OpSetPropertiesOfActor(this.ActorNumber, properties);
            }
