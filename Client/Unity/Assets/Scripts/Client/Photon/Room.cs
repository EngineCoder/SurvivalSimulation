...
namespace UFO.Realtime
{
    ...
    {
        /// <summary>
        /// A reference to the Client which is currently keeping the connection and state.
        /// </summary>
        ...
        public new bool IsOpen
        {
            ...
            set
            {
                if (value != this.isOpen)
                {
                    if (!this.isOffline)
                    {
                        this.Client.OpSetPropertiesOfRoom(new Hashtable() { { GamePropertyKey.IsOpen, value } });
                    }
                }
        ...
        public new bool IsVisible
        {
            ...
            set
            {
                if (value != this.isVisible)
                {
                    if (!this.isOffline)
                    {
                        this.Client.OpSetPropertiesOfRoom(new Hashtable() { { GamePropertyKey.IsVisible, value } });
                    }
                }
        ...
        public new byte MaxPlayers
        {
            ...
            set
            {
                if (value != this.maxPlayers)
                {
                    if (!this.isOffline)
                    {
                        this.Client.OpSetPropertiesOfRoom(new Hashtable() { { GamePropertyKey.MaxPlayers, value } });
                    }
                }
        ...
        /// Define expected players in the methods: <see cref="Client.OpCreateRoom"/>, <see cref="Client.OpJoinRoom"/> and <see cref="Client.OpJoinRandomRoom"/>.
        /// </remarks>
        ...
        public int PlayerTtl
        {
            ...
            set
            {
                if (value != this.playerTtl)
                {
                    if (!this.isOffline)
                    {
                        this.Client.OpSetPropertyOfRoom(GamePropertyKey.PlayerTtl, value);  // TODO: implement Offline Mode
                    }
                }
        ...
        public int EmptyRoomTtl
        {
            ...
            set
            {
                if (value != this.emptyRoomTtl)
                {
                    if (!this.isOffline)
                    {
                        this.Client.OpSetPropertyOfRoom(GamePropertyKey.EmptyRoomTtl, value);  // TODO: implement Offline Mode
                    }
                }
        ...
        /// This list is defined when creating the room and can't be changed afterwards. Compare: Client.OpCreateRoom()
        /// </summary>
        ...
        protected internal override void InternalCacheProperties(Hashtable propertiesToCache)
        {
            ...
            {
                this.Client.InRoomCallbackTargets.OnMasterClientSwitched(this.GetPlayer(this.masterClientId));
            }
        }
        ...
        public virtual bool SetCustomProperties(Hashtable propertiesToSet, Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            ...
            if (this.isOffline)
            {
                ...
                // invoking callbacks
                this.Client.InRoomCallbackTargets.OnRoomPropertiesUpdate(propertiesToSet);

            }
            else
            {
                // send (sync) these new values if in online room
                return this.Client.OpSetPropertiesOfRoom(customProps, expectedProperties, webFlags);
            }
        ...
        public bool SetPropertiesListedInLobby(string[] lobbyProps)
        {
            ...
            return this.Client.OpSetPropertiesOfRoom(customProps);
        }
        ...
        public bool SetMasterClient(Player masterClientPlayer)
        {
            ...
            return this.Client.OpSetPropertiesOfRoom(newProps, prevProps);
        }
        ...
        public bool ClearExpectedUsers()
        {
            ...
            return this.Client.OpSetPropertiesOfRoom(props, expected);
        }
